...
const SingleProduct = () => {
  ...
  const addToWishlistHandler = async (product) => {
    try {
      ...
      toast.success("Product added to the Favourites!");
    } catch (error) {
      console.error(error);
    }
  };
  ...
  const removeFromWishlistHandler = async (product) => {
    ...
    toast.success("Product removed from the Favourites!");
  };
              ...
              <button
                ...
                onClick={() => {
                  if (loginState) {
                    ...
                    toast.error(
                      "You must be logged in to remove products from the Favourites"
                    );
                  }
                }}
              >
              ...
              <button
                ...
                onClick={() => {
                  if (loginState) {
                    ...
                    toast.error(
                      "You must be logged in to add products to the Favourites"
                    );
                  }
                }}
              >
